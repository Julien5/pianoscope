...
void main() {
  group('GrandStaffLayout', () {
    ...
    test('content height derives from staffSpaceSize and staffGap', () {
      expect(
        GrandStaffLayout.contentHeightFor(const GrandStaffParameters()),
        200,
      );
      expect(
    ...
    test('staffs are stacked with the explicit gap', () {
      ...
      expect(layout.upperStaff.box.top, 30);
      expect(layout.lowerStaff.box.top, 30 + 40 + 60);
      expect(layout.upperStaff.box.height, 40);
      expect(layout.lowerStaff.box.height, 40);
