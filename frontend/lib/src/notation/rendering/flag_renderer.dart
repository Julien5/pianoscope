// lib/src/notation/rendering/flag_renderer.dart
...
class FlagRenderer {
  ...
  void paint(
    ...
    _paintFlagsWithGlyphs(canvas, stemEnd, direction, flagCount, color ?? this.color);
  }
  ...
  void _paintFlagsWithGlyphs(
    ...
    final x = stemEnd.dx - textPainter.width * 0.1;
    final y = stemEnd.dy - textPainter.height * 0.5;
